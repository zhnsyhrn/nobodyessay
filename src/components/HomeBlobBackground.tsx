...
export const HomeBlobBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Helper to calculate homepage blob radius (reduced 5% from previous size)
    const getBaseRadius = (factor: number) => {
      const dim = Math.max(width, height);
      const minRadius = isMobile ? 156 : 218;
      ...
      blobs = [
        {
          ...
          vx: 0.8,
          vy: 0.5,
          radius: getBaseRadius(0.40),
          baseRadius: getBaseRadius(0.40),
        ...
        },
        {
          ...
          vx: -0.6,
          vy: -0.6,
          radius: getBaseRadius(0.36),
          baseRadius: getBaseRadius(0.36),
        ...
        },
        {
          ...
          vx: -0.5,
          vy: 0.4,
          radius: getBaseRadius(0.33),
          baseRadius: getBaseRadius(0.33),
