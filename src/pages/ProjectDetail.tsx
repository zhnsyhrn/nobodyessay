  ...
  return <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="max-w-[740px] mx-auto space-y-8">
            ...
            lineHeight: 1.8
                ...
                <li>Reviewed responsiveness issues and reorganised customer service content.</li>
            ...
            lineHeight: 1.8
                ...
                <li>Visualised updated layouts for pages such as corporate, products, company profile, and articles, ensuring ease of web development by reusing existing templates and assets.</li>
                <li>Delivered updated information architecture (before/after), new illustration placements, refreshed colour usage, optimised page content layouts, and bilingual designs (Bahasa Malaysia + English).</li>
            ...
            lineHeight: 1.8
                ...
                <li>Reorganised customer service content from a messy FAQs page into a centralised help centre.</li>
      ...
      <div className="space-y-4">
        ...
        {/* Real photo snapshots - Stacked on mobile, 2 per row on sm+ (Original ratio) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
          {flaaahHeroImages.map((img, i) => (
            <div key={i} className="w-full overflow-hidden rounded-xl bg-muted">
              <img src={img} alt={`Flaaah photo ${i + 1}`} className="w-full h-auto block hover:scale-105 transition-transform duration-300" loading="lazy" />
            </div>
          ))}
        </div>

        {/* IG Brand Post Graphics - Stacked on mobile, 2 per row on sm+ (Original ratio) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
          {flaaahIgImages.map((img, i) => (
            <div key={i} className="w-full overflow-hidden rounded-[10px] bg-muted">
              <img src={img} alt={`Flaaah brand graphic ${i + 1}`} className="w-full h-auto block hover:scale-105 transition-transform duration-300" loading="lazy" />
            </div>
          ))}
        </div>
      </div> :
