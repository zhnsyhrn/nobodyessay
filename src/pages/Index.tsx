  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-8 sm:py-12 lg:py-20 px-4 sm:px-6 fade-in pb-4 sm:pb-6">
        <div className="max-w-6xl mx-auto text-left">
          ...
          <p style={{
          color: '#606060'
        }} className="font-jakarta text-lg sm:text-lg max-w-2xl leading-[27px] sm:leading-relaxed px-1 mb-6 sm:mb-8 sm:px-0">Where ideas play, and designs grow — product design, brand design systems, and rapid R&D for startups.</p>
