  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="pt-4 pb-6 sm:py-12 lg:py-20 px-3 sm:px-6 fade-in min-h-[calc(100vh-80px)] sm:min-h-0 flex items-center">
        <div className="max-w-4xl mx-auto text-left w-full">
          ...
          <p className="font-display text-base sm:text-lg max-w-2xl leading-relaxed mb-6 sm:mb-8 text-muted-foreground">I'd learned to code this site using AI so that I can show my collection of works.</p>
