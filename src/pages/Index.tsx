        ...
        <div className="max-w-6xl mx-auto text-left lg:text-center relative z-10">
          ...
          <div className="flex flex-col items-center px-1 sm:px-2 mt-8 lg:mt-12 relative z-10 group">
            <div className="relative w-full max-w-2xl">
              ...
              <div className="relative flex items-center w-full max-w-2xl bg-white border border-border/50 rounded-full shadow-sm px-4 py-2.5 sm:py-3 mx-auto transition-all duration-300 hover:shadow-md focus-within:shadow-md focus-within:border-border/80 focus-within:bg-white">
